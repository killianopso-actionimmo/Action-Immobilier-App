...
const Sidebar: React.FC<SidebarProps> = ({ currentMode, onModeChange }) => {
    ...
    return (
        <div className="w-64 h-screen bg-white/70 backdrop-blur-md border-r border-white/20 flex flex-col fixed left-0 top-0 z-50 transition-all duration-300 shadow-xl">
            {/* Logo Area */}
            <motion.div
                className="h-24 flex items-center justify-center px-4 border-b border-slate-100/50"
